  ...
  input "Proceed with deployment?"
   ...
   stage('docker deploy') {
     ...
     withCredentials([usernamePassword(credentialsId: '47f84f4d-ab54-4743-8250-875b54c8bab9', passwordVariable: 'dockerPassword', usernameVariable: '')]) {
      ansiblePlaybook credentialsId: '43195002-dcf4-4397-bb78-adf4429b5968',  playbook: 'DeployDocker.yml', extraVars: [ HOST: host, USERNAME: env.dockerUsername, PASSWORD: passwordVariable]
     }
   }
}
